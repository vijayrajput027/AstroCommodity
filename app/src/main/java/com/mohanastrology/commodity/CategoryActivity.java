...
public class CategoryActivity extends AppCompatActivity implements CommodityAdapter.ViewOnClickButtonListner{

    private RecyclerView recyclerView;
    private CommodityAdapter adapter;
    private ProgressDialog pDialog;
    private List<CommodityPojo> listitem;
    private String  category_id,result,prediction_id,name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prediction_id=intent.getStringExtra("prediction_id");
        ...
        adapter = new CommodityAdapter(CategoryActivity.this, listitem);
        ...
        class CommodityitemAsync extends AsyncTask<String,String,JSONObject>
        {
          ...
          protected void onPreExecute() {
            ...
            protected JSONObject doInBackground(String... args) {
                ...
                params.put("cat_id", prediction_id);

                   JSONObject json = jsonParser
                            .makeHttpRequest(AppUrl.predictionCategoryUrl, "POST", params);
