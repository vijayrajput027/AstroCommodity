...
public class YesterdayRashiphalFragment extends Fragment {
  ...
  String date,rash_id,result,name;
  ...
  String dailyremedy,luckpercentage,sub_category,favourite_planet,
            ...
            auspicious_food,in_auspicious_work,in_auspicious_food,luckno;


    public YesterdayRashiphalFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView=inflater.inflate(R.layout.fragment_yesterday_rashiphal, container, false);
    ...
    public class YesterdayAsync extends AsyncTask<String,String,JSONObject>
    {
        @Override
                ...
                if (json != null) {
                    {
                        ...
                        if(result.equals("1")) {
                            ...
                            for (int i = 0; i <= jsonArray.length(); i++) {
                                ...
                                in_auspicious_work = jsonObject.getString("inauspicious_work");
                                in_auspicious_food = jsonObject.getString("inauspicious_food_item");
                                String dailyremedy = jsonObject.getString("daily_remedy");
                            }
                        }
                    }
                    return json;
